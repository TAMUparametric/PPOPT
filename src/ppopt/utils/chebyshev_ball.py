...
def chebyshev_ball(A: numpy.ndarray, b: numpy.ndarray, equality_constraints: Optional[Sequence[int]] = None,
                   bin_vars: Optional[Sequence[int]] = None, deterministic_solver: str = 'gurobi'):
    r"""
