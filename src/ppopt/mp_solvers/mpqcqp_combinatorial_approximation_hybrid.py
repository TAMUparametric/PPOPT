...
def solve(program: MPQCQP_Program, options: ApproxOptions = ApproxOptions()) -> Solution:
    """
    ...
    for i in range(max_depth):
        ...
        for child_set in feasible_sets:
            ...
            # if program.check_optimality(child_set):
                ...
                critical_region_list = program.gen_hybrid_approx_cr_from_active_set(child_set, initial_point, options)
